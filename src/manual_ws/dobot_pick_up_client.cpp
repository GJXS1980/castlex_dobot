...
{
    ROS_INFO("Yay! Grabbing is in progress");
    //ros::shutdown();
}
...
{
    ros::init(argc, argv, "Dobot_Grasp_client");
    ros::NodeHandle n;

    ros::Subscriber subPick = n.subscribe("DetectDone", 1000, PickUpCallback);
