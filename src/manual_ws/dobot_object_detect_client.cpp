...
int main(int argc, char** argv)
{
    ...
    node.param("select_tag", select_tag, 3);  /*0就表示不启动重复识别操作，3表示启动重复识别操作*/  

    ros::Subscriber subPick = n.subscribe("control_success", 1000, PickUpCallback);
